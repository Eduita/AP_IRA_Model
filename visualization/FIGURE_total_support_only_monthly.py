...
def adapted_box_plot_on_ax(data_dict, time, scenario, matching, ax,
                           title='', show_legend=True, bottom=True, left=True, top=False, colors=None, show_axis=False):
    """
...
adapted_box_plot_on_ax(cleaned_datafiles_with_matching, time, 'C',matching, ax=axs[0, 1], title='Scenario B', show_legend=False, bottom=False, left= False, top=True, show_axis=True)
adapted_box_plot_on_ax(cleaned_datafiles_with_matching, time, 'D',matching, ax=axs[0, 2], title='Scenario C', show_legend=True, bottom=False, left= False, top=True, show_axis=True)
...
adapted_box_plot_on_ax(cleaned_datafiles_with_matching, time+7, 'C',matching, ax=axs[1, 1], title='Scenario B', show_legend=False, bottom=True, left= False, show_axis=True)
adapted_box_plot_on_ax(cleaned_datafiles_with_matching, time+7, 'D',matching, ax=axs[1, 2], title='Scenario C', show_legend=False, bottom=True, left= False, show_axis=True)

plt.savefig(rf"{ROOT_FILES}/visuals/TC Monthly.png", dpi=500)
...
plt.savefig(rf"{ROOT_FILES}/visuals/TC Yearly.png", dpi=300)
...
plt.savefig(rf"{ROOT_FILES}/visuals/TC Hourly.png", dpi=300)
