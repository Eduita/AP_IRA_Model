...
times = [2023, 2030]
scenarios = ["B", "C", "D"]
technologies = ["AP_CCS", "AP_BH2S", "AP_AEC"]
CI_technologies = ["AP CCS", "AP BH2S", "AP AEC"]
metrics = ["_NPV", "_CAC"]
...
def compare_policy_scenarios_subplot(
    ...
    if matching == "monthly" or matching == "CBAM":
        ranges = {"A": [-300, 300], "B": [-300, 200], "C": [-800, 300], "D": [-300, 300]}
        ax.set_ylim(*ranges[scenario])
    elif matching in ["hourly", "yearly"]:
        ranges = {"A": [-200, 400], "B": [-200, 400], "C": [-3500, 400], "D": [-1000, 400]}
        ax.set_ylim(*ranges[scenario])
...
def compare_cac_scenarios_subplot(
    ...
    ax.set_ylim(-800, 400)  # -600
    if matching == "hourly" and scenario == "C":
        ax.set_ylim(-800, 400)  # -2200
...
plt.savefig("FINAL final figures/CAC Experiment baseline.png", dpi=300)
plt.close()
...
plt.savefig("FINAL final figures/CAC Experiment.png", dpi=300)
plt.close()
