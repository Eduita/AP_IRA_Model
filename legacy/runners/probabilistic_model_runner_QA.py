...
CBAM = True  # False or True
matching = "monthly"  # options: hourly, monthly, and yearly
mult = 5  # Multiplies the number of simulations
...
NPV_dataset = run_simulation(100 * mult, NPV=True, isCBAM=CBAM, matching=matching)
...
dataframes_to_excel(dfs, f"test_DATASET{'_CBAM' if CBAM else ''}_{matching}.xlsx")
